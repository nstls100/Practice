...
#import "JsonParsingVC.h"
#import "JsonTableViewCell.h"

@interface JsonParsingVC ()

@end

@implementation JsonParsingVC
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    JsonTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
